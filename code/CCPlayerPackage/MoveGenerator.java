...
public class MoveGenerator {
    ...
    public Move preventEnemyWin() {
        List<DetectedChain> foundChains = new ArrayList<>();
        ...
        for (int i = 0; i < winSituationDetector.getRivalDetectedChains().size(); i++) {
            if (winSituationDetector.getRivalDetectedChains().get(i).getSize() >= 2) {
                foundChains.add(winSituationDetector.getRivalDetectedChains().get(i));
                if(winSituationDetector.getRivalDetectedChains().get(i).getSize() == 3 &&
        ...
        //BLOCK COLUMNS
        blockColumns(foundChains);

                //VERTICAL
                for (int i = 0; i < foundChains.size(); i++) {
                    if (foundChains.get(i).getChainType() == ChainType.VERTICAL) {
                        //WARNING: 3 coins!
                        if (foundChains.get(i).getSize() == 3) {
                            if (foundChains.get(i).getStartPositionRow() - 1 >= 0) {
                                if (manager.getPlayerEnumAtPosition(foundChains.get(i).getStartPositionRow() - 1, foundChains.get(i).getStartPositionCol()) == PlayerEnum.EMPTY) {
                                    return getMoveOfColumn(foundChains.get(i).getStartPositionCol());
                                }
                            }
                        }
                    }
...
//                        if (manager.getPlayerEnumAtPosition(foundChains.get(i).getStartPositionRow(), foundChains.get(i).getStartPositionCol() - 2) == PlayerEnum.RIVAL) {
...
//                                return getMoveOfColumn(foundChains.get(i).getStartPositionCol() - 1);
//                            }
//                        }
//                    }
//                    }
...
//                            if (manager.getPlayerEnumAtPosition(foundChains.get(i).getEndPositionRow(), foundChains.get(i).getEndPositionCol() + 2) == PlayerEnum.RIVAL) {
...
//                                    return getMoveOfColumn(foundChains.get(i).getEndPositionCol() + 1);
//                                }
//                            }
//                        }
//                    }
...
//            }
                ...
                for (int i = 0; i < foundChains.size(); i++) {
                    if (foundChains.get(i).getChainType() == ChainType.HORIZONTAL && foundChains.get(i).getSize() == 2) {
                        if (foundChains.get(i).getStartPositionCol() - 1 >= 0 && foundChains.get(i).getEndPositionCol() + 1 < 7) {
                            //check if left and right are empty
                            if (manager.getPlayerEnumAtPosition(foundChains.get(i).getStartPositionRow(), foundChains.get(i).getStartPositionCol() - 1) != null) {
                                if (manager.getPlayerEnumAtPosition(foundChains.get(i).getStartPositionRow(), foundChains.get(i).getStartPositionCol() - 1) == PlayerEnum.EMPTY) {
                                    if (manager.getPlayerEnumAtPosition(foundChains.get(i).getEndPositionRow(), foundChains.get(i).getEndPositionCol() + 1) != null) {
                                        if (manager.getPlayerEnumAtPosition(foundChains.get(i).getEndPositionRow(), foundChains.get(i).getEndPositionCol() + 1) == PlayerEnum.EMPTY) {
                                            //check falling
                                            //left
                                            if (foundChains.get(i).getStartPositionCol() - 1 >= 0) {
                                            ...
                                            //right
                                            if (foundChains.get(i).getEndPositionCol() + 1 < 7) {
...
//                                    }
                ...
                //DIAGONAL TOP RIGHT - 2 coins with empty fields on left & right
                for (int i = 0; i < foundChains.size(); i++) {
                    if (foundChains.get(i).getChainType() == ChainType.DIAGONAL_TOP_RIGHT && foundChains.get(i).getSize() == 2) {
                        if (foundChains.get(i).getEndPositionCol() + 1 < 7 && foundChains.get(i).getEndPositionRow() - 1 >= 0) {
                            if (manager.getPlayerEnumAtPosition(foundChains.get(i).getEndPositionRow() - 1, foundChains.get(i).getEndPositionCol() + 1) != null) {
                                if (manager.getPlayerEnumAtPosition(foundChains.get(i).getEndPositionRow() - 1, foundChains.get(i).getEndPositionCol() + 1) == PlayerEnum.EMPTY) {
                                    if (foundChains.get(i).getEndPositionRow() - 2 >= 0 && foundChains.get(i).getEndPositionCol() + 2 < 7) {
                                        if (manager.getPlayerEnumAtPosition(foundChains.get(i).getEndPositionRow() - 2, foundChains.get(i).getEndPositionCol() + 2) != null) {
                                            if (manager.getPlayerEnumAtPosition(foundChains.get(i).getEndPositionRow() - 2, foundChains.get(i).getEndPositionCol() + 2) == PlayerEnum.RIVAL) {
                                                return getMoveOfColumn(foundChains.get(i).getEndPositionCol() + 1);
                                            }
                                        }
                                    }
                ...
                //DIAGONAL TOP LEFT - 2 coins with empty fields on left & right
                for (int i = 0; i < foundChains.size(); i++) {
                    if (foundChains.get(i).getChainType() == ChainType.DIAGONAL_TOP_LEFT && foundChains.get(i).getSize() == 2) {
                ...
                for (int i = 0; i < foundChains.size(); i++) {
                    if (foundChains.get(i).getChainType() == ChainType.DIAGONAL_BOTTOM_RIGHT && foundChains.get(i).getSize() == 2) {
                        if (foundChains.get(i).getEndPositionCol() + 1 < 7 && foundChains.get(i).getEndPositionRow() - 1 >= 0) {
                            if (manager.getPlayerEnumAtPosition(foundChains.get(i).getEndPositionRow() - 1, foundChains.get(i).getEndPositionCol() + 1) != null) {
                                if (manager.getPlayerEnumAtPosition(foundChains.get(i).getEndPositionRow() - 1, foundChains.get(i).getEndPositionCol() + 1) == PlayerEnum.EMPTY) {
                                    if (foundChains.get(i).getEndPositionRow() - 2 >= 0 && foundChains.get(i).getEndPositionCol() + 2 < 7) {
                ...
                for (int i = 0; i < foundChains.size(); i++) {
                    if (foundChains.get(i).getChainType() == ChainType.DIAGONAL_BOTTOM_LEFT && foundChains.get(i).getSize() == 2) {
                        if (foundChains.get(i).getEndPositionCol() + 1 < 7 && foundChains.get(i).getEndPositionRow() - 1 >= 0) {
                            if (manager.getPlayerEnumAtPosition(foundChains.get(i).getEndPositionRow() - 1, foundChains.get(i).getEndPositionCol() + 1) != null) {
                                if (manager.getPlayerEnumAtPosition(foundChains.get(i).getEndPositionRow() - 1, foundChains.get(i).getEndPositionCol() + 1) == PlayerEnum.EMPTY) {
                                    if (foundChains.get(i).getEndPositionRow() - 2 >= 0 && foundChains.get(i).getEndPositionRow() - 2 >= 0) {
                                        if (manager.getPlayerEnumAtPosition(foundChains.get(i).getEndPositionRow() - 2, foundChains.get(i).getEndPositionCol() + 2) != null) {
                                            if (manager.getPlayerEnumAtPosition(foundChains.get(i).getEndPositionRow() - 2, foundChains.get(i).getEndPositionCol() + 2) == PlayerEnum.RIVAL) {
                                                return getMoveOfColumn(foundChains.get(i).getEndPositionCol() + 1);
                                            }
                ...
                for (int i = 0; i < foundChains.size(); i++) {
                    //chainSize: 3
                    if (foundChains.get(i).getChainType() == ChainType.HORIZONTAL && foundChains.get(i).getSize() >= 3) {
                        //SET ON LEFT
                        if (foundChains.get(i).getStartPositionCol() - 1 >= 0) {
                            if (manager.getPlayerEnumAtPosition(foundChains.get(i).getStartPositionRow(), foundChains.get(i).getStartPositionCol() - 1) != null) {
                                if (manager.getPlayerEnumAtPosition(foundChains.get(i).getStartPositionRow(), foundChains.get(i).getStartPositionCol() - 1) == PlayerEnum.EMPTY) {
                                    //check falling
                                    if (foundChains.get(i).getEndPositionRow() == 6) {
                                        return getMoveOfColumn(foundChains.get(i).getStartPositionCol() - 1);
                                    } else {
                                        if (foundChains.get(i).getStartPositionRow() + 1 < 7 && foundChains.get(i).getStartPositionCol() - 1 >= 0) {
                                            if (manager.getPlayerEnumAtPosition(foundChains.get(i).getStartPositionRow() + 1, foundChains.get(i).getStartPositionCol() - 1) != PlayerEnum.EMPTY) {
                                                return getMoveOfColumn(foundChains.get(i).getStartPositionCol() - 1);
                                            }
                                        }
                        ...
                        if (foundChains.get(i).getSize() == 3) {
                            if (foundChains.get(i).getEndPositionCol() + 1 < 7 && foundChains.get(i).getEndPositionRow() + 1 < 7) {
                                if (manager.getPlayerEnumAtPosition(foundChains.get(i).getEndPositionRow() + 1, foundChains.get(i).getEndPositionCol() + 1) != null) {
                                    if (manager.getPlayerEnumAtPosition(foundChains.get(i).getEndPositionRow() + 1, foundChains.get(i).getEndPositionCol() + 1) == PlayerEnum.EMPTY) {
                                        //check falling
                                        if (foundChains.get(i).getEndPositionRow() + 1 == 6) {
                                            return getMoveOfColumn(foundChains.get(i).getEndPositionCol() + 1);
                                        } else {
                                            if (foundChains.get(i).getEndPositionRow() + 2 < 7 && foundChains.get(i).getEndPositionCol() + 1 < 7) {
                ...
                for (int i = 0; i < foundChains.size(); i++) {
                    if (foundChains.get(i).getChainType() == ChainType.DIAGONAL_BOTTOM_LEFT) {
                        if (foundChains.get(i).getSize() == 3) {
                            if (foundChains.get(i).getStartPositionCol() - 1 >= 0 && foundChains.get(i).getStartPositionRow() + 1 < 7) {
                                if (manager.getPlayerEnumAtPosition(foundChains.get(i).getStartPositionRow() + 1, foundChains.get(i).getStartPositionCol() - 1) != null) {
                                    if (manager.getPlayerEnumAtPosition(foundChains.get(i).getStartPositionRow() + 1, foundChains.get(i).getStartPositionCol() - 1) == PlayerEnum.EMPTY) {
                                        //check falling
                                        if (foundChains.get(i).getStartPositionRow() + 1 == 6) {
                                            return getMoveOfColumn(foundChains.get(i).getStartPositionCol() - 1);
                                        } else {
                                            if (manager.getPlayerEnumAtPosition(foundChains.get(i).getStartPositionRow() + 2, foundChains.get(i).getStartPositionCol() - 1) != PlayerEnum.EMPTY) {
                                                return getMoveOfColumn(foundChains.get(i).getStartPositionCol() - 1);
                                            }
                                        }
                                    }
            ...
            public void blockColumns(List<DetectedChain> foundChains ){
                //BLOCK COLUMNS
                for (int i = 0; i < foundChains.size(); i++) {
                    if (foundChains.get(i).getSize() == 3) {
                        //HORIZONTAL LEFT
